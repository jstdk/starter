...
class SignInUpButtonComponent extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  const SignInUpButtonComponent({super.key, required this.formKey});

  @override
  State<SignInUpButtonComponent> createState() =>
      _SignInUpButtonComponentState();
}

class _SignInUpButtonComponentState extends State<SignInUpButtonComponent> {
  bool loader = false;
