...
import '../../links/contact_drawer_link_widget.dart';
    ...
    return Drawer(
      child: ListView(
        ...
        children: const [
          ...
          FeaturesDrawerLinkWidget(highlight: true),
          SizedBox(height: 5.0),
          PricingDrawerLinkWidget(highlight: false),
          SizedBox(height: 5.0),
          ContactDrawerLinkWidget(highlight: false),
          SizedBox(height: 5.0),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: const [
          FeaturesHeaderLinkWidget(highlight: true),
