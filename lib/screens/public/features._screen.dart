...
import 'package:starter/components/headers/features_header_component.dart';

import '../../components/links/about_drawer_link_component.dart';
import '../../components/links/about_header_link_component.dart';
import '../../components/links/contact_drawer_link_component.dart';
    ...
    return Drawer(
      child: ListView(
        ...
        children: const [
          ...
          FeaturesDrawerLinkComponent(highlight: true),
          SizedBox(height: 5.0),
          PricingDrawerLinkComponent(highlight: false),
          SizedBox(height: 5.0),
          ContactDrawerLinkComponent(highlight: false),
          SizedBox(height: 5.0),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: const [
          FeaturesHeaderLinkComponent(highlight: true),
